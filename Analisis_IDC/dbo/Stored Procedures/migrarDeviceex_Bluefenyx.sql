CREATE procedure [dbo].[migrarDeviceex_Bluefenyx]
as

print 'truncate deviceex5'
EXEC [10.0.0.5].[FM_Bluefenyx].sys.sp_executesql N'TRUNCATE TABLE dbo.deviceex5'

print 'Insert deviceex5'
insert into [10.0.0.5].[FM_Bluefenyx].[dbo].deviceex5 (deviceid,tipoequipoid,Num_SIM,CodEquipo,LineaCelular,SerialEquipo,IMEI,CodCliente,FechaActivacion,FechaExpiracion,activo,vrid,EsReprogramado,Observaciones,TipoServicioID)
select deviceid,tipoequipoid,Num_SIM,CodEquipo,LineaCelular,SerialEquipo,IMEI,CodCliente,FechaActivacion,FechaExpiracion,activo,vrid,EsReprogramado,'' Observaciones,0 TipoServicioID from [soporte].[dbo].DEVICEEX
