...
-- =============================================
--EXEC SP_Summary_UnidadesSinTX
CREATE PROCEDURE [dbo].[SP_Summary_UnidadesSinTX]
...
*/
				...
				m.plate placa,m.name alias,d.name dispositivo,dt.name tipodispositivo,dx.imei imei,dx.Num_SIM as icc,dx.lineacelular,  dateadd(hh,-6,dategps) as fechaUltimaTX,lr.location ubicacion,r.nombre_Resp,null,null,0,null,null
				...
				placa varchar(25),	alias varchar(150),	dispositivo	 varchar(50),tipodispositivo varchar(50),	imei varchar(50),	
				icc	 varchar(50),	lineacelular varchar(50),		FechaUltimaTX	datetime ,ubicacion varchar(1000),responsable varchar(250),	
				...
				TRUNCATE TABLE Summary_UnidadesSinTX
				 INSERT INTO Summary_UnidadesSinTX (dateinfo, ingenioText,mobileid	,ingenio ,	tipoplan ,	companyid	,compania,	subflota	,estado ,
				placa ,	alias ,	dispositivo	 ,tipodispositivo ,	imei ,	
				icc	,	lineacelular,		FechaUltimaTX,diasDif	 ,ubicacion ,estadoactual,				
				...
				,convert(varchar(50),FechaUltimaTX,120)fechaUltimaTX,datediff(DD,FechaUltimaTX,getdate())diasDif,ubicacion,estadoactual,diagnostico,ticketid,convert(varchar(50),fechaultimagestion,120)fechaultimagestion,comentarios,responsable,1
				from @unidadessinx
...
--				EXEC (@RunStoredProcSQL) AT [10.0.0.4];
				...
				ELSE 'Sin Empresa' END  as ingenioText,mobileid,ingenio,tipoplan,companyid,compania,subflota,estado,
				placa,alias,dispositivo,tipodispositivo,imei,icc,lineacelular
				,convert(varchar(50),FechaUltimaTX,120)fechaUltimaTX,datediff(DD,FechaUltimaTX,getdate())diasDif,ubicacion,estadoactual,diagnostico,ticketid,convert(varchar(50),fechaultimagestion,120)fechaultimagestion,comentarios,responsable,2
